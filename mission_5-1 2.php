...
<input type="password" name="pass" style="ime-mode:disabled;" placeholder="password">z<input type="submit" name="submit"><br>*********************************************</p>
...
<input type="submit" name="edit_submit" value="edit"></p><hr>
    </form>
<?php
    //データベースの情報、接続
 $dsn = 'データベース名';
